      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {courses.map((course) => (
            <Card
              key={course.id}
              className="overflow-hidden flex flex-col transform transition-all duration-300 hover:scale-105 hover:shadow-xl rounded-lg border bg-card"
            >
              ...
              <CardContent className="p-6 flex-grow">
                <CardTitle className="mb-2 font-headline text-lg font-semibold">
                  {course.title}
                </CardTitle>
              ...
              <CardFooter className="flex flex-col items-start p-6 pt-0">
                <div className="w-full flex justify-between items-center mb-4">
                  <Badge variant="default" className="text-lg py-1 px-3 bg-primary/10 text-primary hover:bg-primary/20">
                    {course.price}
                  </Badge>
                </div>
