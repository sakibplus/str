...
import type { Course, NavbarData, NavLink, FooterData } from '@/lib/types';
            ...
            <div>
              ...
              <div className="space-y-6">
                {course.details?.map((detail, index) => (
                  <div key={index}>
                    <h3 className="font-bold font-headline text-xl mb-3">
                      {detail.heading}
                    </h3>
                  ...
                  <div className="p-6 bg-white">
                    <div className="flex justify-between items-center mb-4">
                      {course.price && course.discountedPrice ? (
                        ...
                        <p className="text-3xl font-bold text-primary">
                          {course.price ? `৳${course.price}` : 'আলোচনা সাপেক্ষে'}
                        </p>
                      )}
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      কোর্সটি করে নিজের পছন্দের জবে জয়েন করুন অথবা ফ্রিল্যান্সিং
                      করে আয় করুন।
                    </p>
                    <Button
                      size="lg"
